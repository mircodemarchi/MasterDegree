/**
 * @file multiplierIEEE754_fsmd.cpp
...
multiplierIEEE754_fsmd::multiplierIEEE754_fsmd(sc_core::sc_module_name module_name)
...
multiplierIEEE754_fsmd::~multiplierIEEE754_fsmd()
{
}
...
void multiplierIEEE754_fsmd::fsm() 
{
    ...
    {
#if DEBUG
        cout << __FILE__ << ": state " << state << endl;
#endif
        switch (next_state) 
        {
            case ST_0: 
...
#if DEBUG
                cout << __FILE__
                    << ": op1=" << op1.read().to_string()
                    << "; op2=" << op2.read().to_string()
                    << endl;

                cout << __FILE__
                    << ": Sum of exponents "
                    << exp1.read().to_uint() << " + "
                    << exp2.read().to_uint() << " - 127 = "
                    << tmpexp.read().to_uint() << endl;
                cout << __FILE__ 
                    << ": Sum vector result " 
                    << tmpexp.read().to_string() << endl;
                
                cout << __FILE__
                    << ": Multiplication of mantissa " 
                    << m1.read().to_uint() << " * " << m2.read().to_uint()
                    << " = " << tmpm.read().to_uint64()
                    << endl;
                cout << __FILE__ 
                    << ": Multiplication vector result " 
                    << tmpm.read().range(47, 23).to_string() << " "
                    << tmpm.read().range(22, 0).to_string() << endl;
#endif
